...
lsp.on_attach(function(client, bufnr)
	...
	end, AddDescToOpts(opts, "Workspace symbol"))

	vim.keymap.set("n", "<leader>vd", function()
		vim.diagnostic.open_float()
	end, AddDescToOpts(opts, "Show diagnostic"))
	...
	end, AddDescToOpts(opts, "Code action"))
	vim.keymap.set("n", "<leader>vrr", function()
		vim.lsp.buf.references()
	end, AddDescToOpts(opts, "References"))
	vim.keymap.set("n", "<leader>vrn", function()
		vim.lsp.buf.rename()
	end, AddDescToOpts(opts, "Rename"))
